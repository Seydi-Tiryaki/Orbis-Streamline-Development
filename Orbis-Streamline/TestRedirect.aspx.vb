...
Public Class TestRedirect
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    Diagnostics.Debug.WriteLine("Test Redirect Start: " & Format(m_dtStartTime, "HH:mm:ss.fff"))

    LogError("Start IOT Test Redirect, From: " & Request.UserHostAddress.ToString)
    ...
    If Not Page.IsPostBack Then
      ...
      sSubject = "IOT Test Redirect Called: " & Format(DateTime.UtcNow, "yyyy-MM-dd HH:mm:ss") & " (UTC)"
      If Request.QueryString.Count = 0 Then
        sBody += " No Querystring data on request."
        LogError(" Querystring data on request.")
      Else
      ...
      If zSendEmail(sFrom, sTo, sCC, "", sSubject, sBody) Then
        sBody += vbCrLf & vbCrLf & "Email sent ok..."
      Else
        sBody += vbCrLf & vbCrLf & "Email sent failed..."
      End If
